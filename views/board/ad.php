...
<div itemscope itemtype="http://schema.org/Product">
        <div class="first message">
            ...
            <?php endif?>
            <h1 itemprop="name"><?php echo $ad->getTitle()?> в <?php echo $city->name_in?></h1>
            <div class="clear"></div>
            <div class="quiet"><?php echo __('Added')?>: <?php echo Date::smart_date($ad->addtime) ?>&nbsp; | &nbsp;<?php echo __('Views')?>: <?php echo $ad->views ?>&nbsp; | &nbsp;<a href="#advertisement">Текст объявления</a>&nbsp; | &nbsp;<a href="#characteristics">Характеристики</a>&nbsp; | &nbsp;<a href="#contacts">Контакты</a>&nbsp; | &nbsp;<a href="#price">Цена</a></div>
    ...
    <div class="line_nobg"></div>
            ...
            <?php elseif (count($photos) > 1): ?>
                ...
                <div class="board_gallery">
                    ...
                    <div class="clear"></div>
                        ...
                        <div class="line_nobg"></div> 
            <?endif ?>
            <h2>Текст объявления</h2><a name="advertisement"></a>
            ...
            <div itemprop="offers" itemscope itemtype="http://schema.org/Offer">
                ...
                <dl class="description" itemprop="seller" itemscope itemtype="http://schema.org/Person">
                    <dt>Автор</dt>
                    <dd><strong itemprop="name"><?php echo  $ad->name?></strong> <?if($ad->user_id>0):?><?endif?></dd>
                </dl>
            ...
            <!--noindex--><div id="addabuse" class="hide">
            ...
            <?if(isset($user_ads)):?>
                ...
                <br>
                <div class="alcenter">
                    <h2>Показать <a title="Показать все объявления пользователя <?php echo $ad->name ?>" href="/all.html?userfrom=<?php echo $ad->id?>">все объявления пользователя</a></h2>
                </div>
                <br>
                <div class="clear"></div>
            <?endif?>
