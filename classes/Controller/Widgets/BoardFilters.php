...
class Controller_Widgets_BoardFilters extends Controller_System_Widgets {
    public $json = array(
        'status'=>true,
    );
    ...
    public $template = 'widgets/board_filter_form';    // Шаблон виждета
    ...
    public function action_index()
    {
        ...
        if($cat_alias){
            ...
            $this->_addMainFilter($category_id);
...
//                'all_uri'  => Route::get('board_cat')->uri(),
    ...
    protected function _addMainFilter($category_id){
