...
<!--    --><?php //endif ?>
    ...
    <?php if ($previous_page !== FALSE): ?>
        <li><a href="<?php echo HTML::chars($page->url($previous_page)) ?>"><i class="uk-icon-angle-double-left"></i></a></li>
    <?php endif ?>

    <?php foreach ($links as $i => $content): ?>

        <?php if ($i == $current_page): ?>
            <li class="uk-active"><span><?php echo $content ?></span></li>
        <?php else: ?>
    ...
    <?php if ($next_page !== FALSE): ?>
        <li><a href="<?php echo HTML::chars($page->url($next_page)) ?>"><i class="uk-icon-angle-double-right"></i></a></li>
    <?php endif ?>
